...
BEGIN
  ...
  BEGIN
      ...
      SET @lSMSBuff = Replace( @lSMS,'RequestNumber', ISNULL(@lRequestNumber,'ø'))
      SET @lSMSBuff = Replace( @lSMSBuff,'AllowNumber', ISNULL(@lAllowNumber,'ø'))
...
AS
	...
	BEGIN TRY
      ...
      EXEC spSendPeymankarAllowSMS -- ÅÌ„«‰ò«— ò«— «Ã«“Â ’œÊ—  «ÌÌœ «—”«·
		END
