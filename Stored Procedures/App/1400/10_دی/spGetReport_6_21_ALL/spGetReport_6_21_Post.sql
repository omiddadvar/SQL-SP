...
ALTER PROCEDURE spGetReport_6_21_Post
...
BEGIN
    ...
    SET @lSQL = 'SELECT DISTINCT LPP.LPPostId, A.Area, MPP.MPPostName , MPF.MPFeederName 
        , LPP.LPPostName, LPP.LPPostCode , LPP.PostCapacity
